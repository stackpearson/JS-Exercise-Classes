...
*/
class Lambdasian {
  constructor(lambdasianObject) {
    this.name = lambdasianObject.name;
    this.age = lambdasianObject.age;
    this.location = lambdasianObject.location;
  }
...
class Instructor extends Lambdasian {
  constructor(instructorObject) {
    ...
    this.instructor = instructorObject.instructor;
...
class Student extends Lambdasian {
  constructor(studentObject) {
    super(studentObject);
    this.student = studentObject.student;
